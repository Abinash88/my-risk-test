...
const MenuList = () => {
  ...
  return (
    <div className="md:w-[70vw]">
      <Carousel className="flex items-center justify-betweenz">
        <CarouselContent className="flex items-center gap-2 justify-between">
          {menuData.map((item) => (
              ...
              <button
                className={`w-fit ${
                  activeMenu === item.id
                    ...
                    : "flex border border-[#C7C8C9] bg-[#ECECEE] mx-10 px-10 py-3 text-black"
                }`}
              >
