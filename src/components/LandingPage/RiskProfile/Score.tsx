	...
	return (
		<>
			<div className="flex gap-3 justify-center">
				<p className="p-3 border border-[rgba(0,0,0,0.4)] rounded-lg w-full font-[600] ">
					Probability: 10
				</p>
				<p className="p-3 border border-[rgba(0,0,0,0.4)] rounded-lg w-full font-[600]">
					Impact: 10{" "}
					<span className="text-white bg-[#6095C9] py-2 px-4 rounded-lg ml-3">
						Add
					</span>
				</p>
				<p className="p-3 border border-[rgba(0,0,0,0.4)] rounded-lg w-full font-[600]">
			...
			<div className="mt-6 flex items-center ga-4 justify-between font-[600]">
				<div className="w-[26%]">
					<p>Causes</p>
