      ...
      <div className="bg-white rounded-md p-4">
        <div className="flex flex-col ml-4 mt-2 gap-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-8 mt-4">
            ...
            >
              <option className="bg-white text-black" value="professional">Professional Account</option>
              <option className="bg-white text-black" value="Personal Account">Personal Account</option>
            </select>
          </div>
        </div>
