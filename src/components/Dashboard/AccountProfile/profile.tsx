        ...
        <div className="flex flex-col gap-7 m-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col md:flex-row gap-3 items-start md:items-center">
              ...
              <button className="p-2 ml-5 bg-[rgba(217,217,217,0.87)] font-[500] text-black">
                Change Password
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5 items-start">
            ...
            <select
              name=""
              id=""
              className="border-[2px] w-96 my-2 border-[#0000805a] outline-none py-3 px-5 rounded-md"
            >
