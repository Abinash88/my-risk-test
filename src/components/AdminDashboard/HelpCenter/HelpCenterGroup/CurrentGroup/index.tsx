  ...
  const columns = [
    {
      ...
      render: (text: string, record: any) => (
        ...
        <div className="flex items-center justify-between w-72 md:w-full">
  ...
  return (
    <div className="flex flex-col mt-5">
      <div className="flex flex-col md:flex-row justify-end">
        <div className="w-full md:w-[40rem] mb-2 md:mb-0 mr-2 flex items-center border border-gray-300 rounded-md px-3">
        ...
        <div className="flex w-full justify-evenly mt-2 md:justify-end">
          <EditGroup />
          <AddGroup />
        </div>
      </div>
        ...
        <Table
          ...
          expandable={{
            expandedRowRender: (record) => (
              <p style={{ margin: 0, backgroundColor: "rgba(0,0,0,0.3)", padding:10, borderRadius: 20 }}>{record.answer}</p>
            ),
