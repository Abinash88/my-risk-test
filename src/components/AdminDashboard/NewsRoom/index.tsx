  ...
  return (
    <div className="flex flex-col p-3 mt-5 rounded-lg bg-white">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        <button
          className={`${
            type == tabs.LIVE_NEWS
              ...
              : "bg-white text-black"
          } rounded-lg py-3 shadow-md shadow-gray-400 w-full`}
        ...
        <button
          className={`${
            type == tabs.ARCHIVED_NEWS
              ? "bg-[#000080] text-white"
              : "bg-white text-black"
          } rounded-lg py-3 shadow-md shadow-gray-400 shadow-opacity-10 w-full`}
