        ...
        <div className="w-[96%] ml-2 bg-white shadow-custom-all-sides px-4 py-1 rounded-lg flex justify-between gap-2 items-center">
          ...
          <div className="flex gap-3">
            <div className="items-center">
              <button className="bg-white mt-2 scale-90 text-[#6666B3] hover:text-white hover:bg-[#6666B3] border-[#6666B3] border w-40 py-2 h-10 rounded-lg text-sm">
                View Standings
              </button>
            </div>
            <div className="p-3">
            ...
            <div
              className="text-white scale-90 mr-2 bg-[rgba(160,11,11,0.8)] shadow-custom-all-sides py-2 px-3 flex flex-col gap-1 items-center justify-center rounded-md cursor-pointer"
