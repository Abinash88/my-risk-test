...
const PendingRefer = () => {
  return (
    <div>
      <div className="mt-1 bg-white rounded-md md:px-9 md:py-0 py-9 pt-5">
        <div className="mt-6">
              ...
              <table className="w-[full] overflow-hidden  bg-white border border-gray-200 rounded-lg overflow-x-auto">
                <thead className="bg-purple-50 text-gray-700">
                  <tr>
                    ...
                    <th className="p-3 text-start text-sm capitalize md:min-w-[200px] max-w-[600px] border-r border-[rgba(0,0,0,0.3)]  font-[600] text-black">
                      First name
                    </th>
                    <th className="p-3 text-start text-sm capitalize md:min-w-[150px] max-w-[600px] border-r border-[rgba(0,0,0,0.3)]  font-[600] text-black">
                      Email
                    </th>
                    <th className="p-3 text-left text-sm font-[600] text-black capitalize md:min-w-[110px] border-r border-[rgba(0,0,0,0.3)]">
                      Referral Date
                    </th>
                    <th className="p-3 text-left text-sm font-[600] text-black capitalize md:min-w-[50px] border-r border-[rgba(0,0,0,0.3)]">
                      Cancel
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {paymentActivities.map((activity, index) => (
                    ...
                    >
                      ...
                      <td className="p-3 flex ml-2  text-sm border-r border-[rgba(0,0,0,0.3)]">
                        <div className="bg-red-400 rounded-full p-1">

                        <X className="text-white text-md" />
                        </div>
                      </td>
                    </tr>
                  ))}
