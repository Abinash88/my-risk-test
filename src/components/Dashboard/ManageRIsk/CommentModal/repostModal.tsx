...
const RepostModal: React.FC<PauseModalProps> = ({ isModalOpen, closeModal }) => {
	return (
		<div>
			<Modal
				isOpen={isModalOpen}
			...
			>
				...
				Are you certain you wish to repost this risk? Reposting this risk will return it back to “Open Risk” Section and make it visible.
				</p>
