  ...
  return (
    <div>
      <button
        className={`${
          isMaintenanceMode
            ? "bg-[#000E56] hover:bg-[#000E56]"
            : "bg-[#F04141] hover:bg-[#F04141]"
        ...
        footer={[
          <>
            ...
            {!isMaintenanceMode ? (
              ...
              <Button className="bg-[#002856] text-white" onClick={handleOk}>
                Confirm
              </Button>
            )}
          </>,
      ...
      >
        {isMaintenanceMode ? (
          <div className="flx flex-col">
            <p>
              Are you sure you want to turn website back on? Users will now be
