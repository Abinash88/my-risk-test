		...
		<RegContainer>
			<>
				...
				<img
					...
					/>
					<h4 className="text-[22px] font-[600] text-black text-center mt-4">Enter OTP Code</h4>
                    <p className="mb-6 text-black opacity-70">Enter the 4-digit code sent to your email</p>
				</div>
